...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="safagroom.in" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="safagroom.in" />
      <DynamicFooter location="India" domain="safagroom.in" />
      <WhatsAppFloat />
    </main>
  )
}
